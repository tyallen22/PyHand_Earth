...
def main():
    model = Yolo_v3(n_classes=2, model_size=(416, 416),
                    max_output_size=5,
                    iou_threshold=0.5,
    ...
    assign_ops = load_weights(model_vars, 'D:/Code/School/Python/AnotherTry/yolo-v3/weights/trained_weights_final.h5')
